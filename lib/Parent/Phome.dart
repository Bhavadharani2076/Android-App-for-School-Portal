...
import 'package:schoolportal/Parent/Pevent.dart';
import 'package:schoolportal/Parent/parentpaymentpage.dart';
import 'package:schoolportal/Parent/attendance.dart';
import 'package:schoolportal/Student/Seventspage.dart';
// import 'package:schoolportal/Student/Shomeworkpage.dart';
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Pevent()),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => StdAttendanceReport()),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Pmarksheet()),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ParentPaymentPage()),
                );
              },
            ),
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Pstdprofile()),
                );
              },
            ),
          ],
...
class Pattendancesheet extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<Pattendancesheet> {
