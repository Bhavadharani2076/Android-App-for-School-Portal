...
import 'package:schoolportal/Student/StdAttendanceReport.dart';
import 'package:schoolportal/Student/Seventspage.dart';
import 'package:schoolportal/Student/Shomeworkpage.dart';
import 'package:schoolportal/Student/finance.dart';
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text('ExamMarks Page'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Examarkspage()), // Navigate to Financial Report Page (to be implemented)
                );
              },
            ),
...
class _HomePageState extends State<StdAttendance> {
